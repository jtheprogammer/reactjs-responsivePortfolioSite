...
const portfolioItems = [
  {
    ...
    title: "My Website",
    description:
      "This custom website was created using ReactJS18 and deployed with Google Firebase.",
  ...
  },
  {
    ...
    description:
      "An Apple Notes-inspired app. CRUD operations are handled by a RESTful API built using Django REST Framework. Users can also toggle between a light and dark mode.",
  ...
  },
  {
    ...
    description:
      "A social media-inspired app where authorized users can share and like posts. CRUD operations are handled by an API built on ExpressJS, and data is stored with MongoDB. Users are able to signup manually (via JWT) or through Google (OAuth). This app was styled using the Material-UI library.",
  ...
  },
  {
    ...
    description:
      "A multi-page app where users can keep track of their existing projects, along with their associated clients. Data querying and mutations, along with project-client referencing, are handled using Apollo GraphQL. This app is styled using Bootstrap.",
  ...
  },
  {
    ...
    description:
      "A calendar app built from scratch on React and styled with TailwindCSS. The code for this project exists in both JavaScript and TypeScript.",
  ...
  },
  {
    ...
    description:
      "This ReactJS app retrieves real-time cryptocurrency information from the CoinGecko API using Axios. No API key needed, just download the source code from Github and try it out. Searching is case insensitive and uses the complete name of the crypto token.",
  ...
  },
  {
    ...
    description:
      "A React Native app built using the Expo CLI that displays a UI design for an NFT marketplace.",
    link: `${baseGhUrl}/react-native-nft-marketplace`,
  },
];

const Portfolio = () => {
  const { portfolioRef } = useContext(ActiveNavContext);
  return (
